            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center">
                        <h1>Resultados de busca para: @isset($termo)<i>"{{$termo}}"</i>@endisset</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="shop_grid_product_area">
                      ...
                      @forelse ($produtos as $produto)
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 mb-4">
							...
							<!-- fim produto -->
                      @empty
                        <div class="buscavazia">
                        <div class="buscavazia">Desculpe, não encontramos resultados para a sua busca<br><br></div> <div><a href="categoria" class="btn comprar buscavazia">Confira nossos produtos</a></div>
</div>
                    @endforelse
